...
function ejecutar(cant, total) {
    ...
    $.ajax({
        ...
        data: {ejecutables: $ejecutables, ejecutablesad: $ejecutablesad, ejecutables2: $ejecutables2,recorrido: $recorrido, a: a, pasa: $pasa, zero_bueno: $zero_bueno, limpia: $limpia, cant: cant, total: total, consecutivo: $consecutivo, status: $status},
        async: true,
        dataType: 'json'
    }).done(function(response){
        $.each(response, function( index, value ) {  
            switch(index) {
                case "ejecutables":
                    $ejecutables = value;
                    if($ejecutables == 1 && $ejecutablesad == 0 && $ejecutables2 ==0 && $recorrido == 0 && $pasa == 0 && $zero_bueno == 0 && $limpia == 0) {
                        if($pasoBarra < 1) {
                ...
                case "ejecutablesad":
                    $ejecutablesad = value;
                    if($ejecutables == 1 && $ejecutablesad == 1 && $ejecutables2 ==0 && $recorrido == 0 && $pasa == 0 && $zero_bueno == 0 && $limpia == 0) {
                        if($pasoBarra < 2) {
                            $barProgress += 16.66666666666667;
                        }
                        cargaBarra();
                ...
                case "ejecutables2":
                $ejecutables2 = value;
                if($ejecutables == 1 && $ejecutablesad == 1 && $ejecutables2 ==1 && $recorrido == 0 && $pasa == 0 && $zero_bueno == 0 && $limpia == 0) {
                    if($pasoBarra < 2) {
                        $barProgress += 16.66666666666667;
                    }
                    cargaBarra();
                ...
                case "recorrido":
                    $recorrido = value;
                    if($ejecutables == 1 && $ejecutablesad == 1 && $ejecutables2 ==1 && $recorrido == 1 && $pasa == 0 && $zero_bueno == 0 && $limpia == 0) {
                        if($pasoBarra < 3) {
                            $barProgress += 16.66666666666667;
                        }
                        cargaBarra();
                ...
                case "pasa":
                    $pasa = value;
                    if($ejecutables == 1 && $ejecutablesad == 1 && $ejecutables2 ==1 && $recorrido == 1 && $pasa == 1 && $zero_bueno == 0 && $limpia == 0) {
                        if($pasoBarra < 4) {
                            $barProgress += 16.66666666666667;
                        }
                        cargaBarra();
                ...
                case "zero_bueno":
                    $zero_bueno = value;
                    if($ejecutables == 1 && $ejecutablesad == 1 && $ejecutables2 ==1 && $recorrido == 1 && $pasa == 1 && $zero_bueno == 1 && $limpia == 0) {
                        if($pasoBarra < 5) {
                            $barProgress += 16.66666666666667;
                        }
                        cargaBarra();
                ...
                case "limpia":
                    $limpia = value;
                    if($ejecutables == 1 && $ejecutablesad == 1 && $ejecutables2 ==1 && $recorrido == 1 && $pasa == 1 && $zero_bueno == 1 && $limpia == 1) {
                        if($pasoBarra < 6) {
                            $barProgress += 16.66666666666667;
                        }
                        cargaBarra();
